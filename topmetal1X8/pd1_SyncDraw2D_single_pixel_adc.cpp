...
//n2.close();
        ...
        // c1->Modified();
        // c1->Update();
c1->SaveAs(TString::Format("../data/runData/%s/adc_xbeam_%d_pede_%d_pixel_%d.png",store_file_name,fileId,pedeId,ip));
rootapp->Run();
return 0;
